...
| 5 | Freie Texte (Name, Beschreibung, Titel) ohne Längenbegrenzung. | niedrig | behoben — höchstens 500 Zeichen. | `internal/api/validierung_test.go: TestPlaceInputBegrenztTextlaenge` |
